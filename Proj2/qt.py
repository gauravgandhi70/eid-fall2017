...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_11.setGeometry(QtCore.QRect(280, 10, 131, 21))
        ...
        self.lineEdit_temp.textChanged['QString'].connect(self.curr_temp_time.setText)
        self.lineEdit_humid.textChanged['QString'].connect(self.curr_hum_time.setText)
        self.lineEdit_humid_2.textChanged['QString'].connect(self.avg_hum_time.setText)
        self.lineEdit_temp_2.textChanged['QString'].connect(self.avg_temp_time.setText)
        self.lineEdit_humid_4.textChanged['QString'].connect(self.min_hum_time.setText)
        self.lineEdit_temp_3.textChanged['QString'].connect(self.min_temp_time.setText)
        self.lineEdit_humid_5.textChanged['QString'].connect(self.max_hum_time.setText)
        self.lineEdit_temp_4.textChanged['QString'].connect(self.max_temp_time.setText)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_11.setText(_translate("Dialog", "Data Requested on"))
        ...
        self.curr_hum_time.setText(_translate("Dialog", "Data Requested on"))
        self.min_hum_time.setText(_translate("Dialog", "Data Requested on"))
        self.min_temp_time.setText(_translate("Dialog", "Data Requested on"))
        self.max_hum_time.setText(_translate("Dialog", "Data Requested on"))
        self.max_temp_time.setText(_translate("Dialog", "Data Requested on"))
        self.curr_temp_time.setText(_translate("Dialog", "Data Requested on"))
        self.avg_hum_time.setText(_translate("Dialog", "Data Requested on"))
        self.avg_temp_time.setText(_translate("Dialog", "Data Requested on"))
